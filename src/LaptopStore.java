...
public class LaptopStore {
    ...
    public Map<FilterOption, Float> createFilter(){
        ...
        while (continueSelection){
            ...
            int key = Utilities.GetIntegerFormConsole(scanner,"");
    ...
    private void addOption(Map<FilterOption, Float> filter) {
        ...
        int option = Utilities.GetIntegerFormConsole(scanner,"Введите номер: ");
        ...
        switch (key) {
            case RAM -> {
                ...
                value = Utilities.GetFloatFormConsole(scanner, "Введите значение: ");
            ...
            case COLOR -> {
                ...
                printAllColors();
                value = Utilities.GetFloatFormConsole(scanner, "Введите номер: ");
